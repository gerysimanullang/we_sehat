...
<head>
    ...
    <link rel="stylesheet" href="daftarObat.css">
    ...
    <div class="diAtas">
        ...
        <main>
            <div class="container3">
                ...
                <a href="../tambahObat/tambahObat.php">
                    <div class="keTambahObat">Tambah Obat</div>
                </a>
            </div>
            <div class="container4">
                <h2 class="hDaftarObat">Daftar Obat</h2>
                <hr>
                <table>
                    <thead>
                        <tr>
                                ...
                                echo "
                                    <tr>
                                        ...
                                        <td style='display:flex'>
                                            ...
                                            <form action='../editObat/editObat.php' method='POST'>
                                                <input type='hidden' name='id_edit' value=".$row['id'].">
                                                <input type='submit' value='Edit'>
                                            </form>

                                            <form action='../hapusObat/hapusObat.php' method='POST'>
